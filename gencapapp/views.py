...
def home(request):
	return render(request, 'gencapapp/index.html')


def faq(request):
	return render(request, 'gencapapp/faq.html')


def plan(request):
	return render(request, 'gencapapp/plan.html')

def otherpayment(request):
    return render(request, 'gencapapp/otherpayment.html')


def about(request):
	return render(request, 'gencapapp/company.html')


def career(request):
	return render(request, 'gencapapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('gencapapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'gencapapp/login.html')


def privacy(request):
	return render(request, 'gencapapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'gencapapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('gencapapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('gencapapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to Aspen-FM',
			plain_message,
		...
		second_template= render_to_string('gencapapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with Aspen-FM!",
		...
		#try:
			#send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@Aspen-FM.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'gencapapp/register.html', context)
...
def dashboard(request):
	...
	return render(request, 'gencapapp/dashboardtwo.html', context)
...
def admindashboard(request):
	...
	return render(request, 'gencapapp/adminpage.html', context)


def terms(request):
	return render(request, 'gencapapp/terms.html')


def realestate(request):
	return render(request, 'gencapapp/realestate.html')


def crypto(request):
	return render(request, 'gencapapp/crypto.html')


def forex(request):
	return render(request, 'gencapapp/forex.html')


def nft(request):
	return render(request, 'gencapapp/nft.html')


def contact(request):
	return render(request, 'gencapapp/contact.html')


def stocks(request):
	return render(request, 'gencapapp/stocks.html')


def agriculture(request):
	return render(request, 'gencapapp/agriculture.html')


def gold(request):
	return render(request, 'gencapapp/gold.html')


def retirement(request):
	return render(request, 'gencapapp/retirement.html')

@login_required(login_url='signin')
def investmentPlans(request):
	return render(request, 'gencapapp/investmentplans.html')
...
def retirementDeposit(request):
	...
	context= {'form':form}
	return render(request, 'gencapapp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'gencapapp/realestateDepositForm.html', context)
...
def cryptoDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'gencapapp/cryptoDepositForm.html', context)
...
def stocksDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'gencapapp/StocksDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'gencapapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	...
	if price_amount and pay_currency:
		...
		payload=json.dumps({
			...
			"success_url": "https://www.Aspen-FM.com/dashboard",
			#our success url will direct us to the get_payment_status view for balance top ups
			"cancel_url": "https://www.Aspen-FM.com/dashboard"
		})
		...
		template= render_to_string('gencapapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
		plain_message= strip_tags(template)
		...
		emailmessage.send()
		try:
			send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@Aspen-FM.com'])
		except BadHeaderError:
			pass
		return redirect(generated_link)
		context={}
	return render(request, 'gencapapp/deposittwo.html', context)
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@Aspen-FM.com'])
	...
	context={}
	return render(request, 'gencapapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'gencapapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'gencapapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'gencapapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'gencapapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'gencapapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'gencapapp/referralprofilestwo.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'gencapapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('gencapapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('gencapapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'gencapapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('gencapapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'gencapapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'gencapapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('gencapapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('gencapapp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@Aspen-FM.com'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'gencapapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'gencapapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('gencapapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('gencapapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@Aspen-FM.com'])
			except BadHeaderError:
				pass
	...
	return render(request, 'gencapapp/reinvest.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		amount= request.POST.get('amount')
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['info@Aspen-FM.com'])
	...
	return render(request, 'gencapapp/loan.html')
...
def portfolio(request):
	...
	return render(request, 'gencapapp/portfolio.html', context)